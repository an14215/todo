...
public class PhotoAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        ((TextView) convertView.findViewById(R.id.tvDescription)).setText(photo.getDescription());
           ...
           //((ImageView)convertView.findViewById(R.id.ivPhoto)).setImageURI(Uri.parse(new File(photo.getFileName()).toString()));
        ...
        if(imgFile.exists()){
            ...
            ivDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    photos.remove(i);
                    PhotoAdapter.super.notifyDataSetChanged();
                }
            });

           // ivPhoto.setImageBitmap(decodeSampledBitmapFromResource( imgFile, 150, 150));
